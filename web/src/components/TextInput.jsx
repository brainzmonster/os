...
// Axios is used for making HTTP requests to the brainzOS API
...
export default function TextInput() {
  ...
  // Sends a prompt to the brainzOS backend for generation
  const handleQuery = async () => {
    ...
    try {
      ...
      setOutput("Error: Unable to reach brainzOS");
    } finally {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      ...
      {/* Button to send the input to brainzOS */}
      <button
        className="mt-2 px-4 py-2 bg-blue-600 text-white rounded"
        onClick={handleQuery}
        disabled={loading}
      >
        {loading ? "Processing..." : "Send to brainzOS"}
      </button>
